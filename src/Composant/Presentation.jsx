...
export default function Presentation() {
    return (
        <div className=' h-[70vh] flex  justify-center z-10'>
            <div className=' bg-[#15616d65] absolute flex flex-col gap-7  text-white rounded-lg'>

                <div className='w-full flex justify-center items-center gap-20'>
<div>

                        <h2 className='text-[60px] text-center font-sans font-extrabold  '>Anthony Dumartin</h2>
                        <h3 className='text-xl text-center font-sans'>En recherche d'alternance de Développeur Full-Stack</h3>
</div>
